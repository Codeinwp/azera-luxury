...
module.exports = function(grunt){
    ...
    grunt.initConfig({
            ...
            target: {
                options: {
                    ...
                    processPot: function( pot, options ) {
                        pot.headers['report-msgid-bugs-to'] = 'http://www.codeinwp.com/';
                        pot.headers['language-team'] = 'CodeinWP';
                        pot.headers['last-translator'] = 'CodeinWP';
                        pot.headers['language-team'] = 'CodeinWP';
                        return pot;
                    },
        ...
        checktextdomain: {
            standard: {
                options:{
                    text_domain: [ 'azera-shop-luxury'], //Specify allowed domain(s)
