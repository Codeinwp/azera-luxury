						...
						<div id="intro-section" class="intro-section">
							...
							<?php
								...
								if( !empty($azera_shop_header_title) ){
									echo '<h1 id="intro_section_text_1" class="intro text-center">'.esc_attr($azera_shop_header_title).'</h1>';
								} elseif ( isset( $wp_customize )   ) {
									echo '<h1 id="intro_section_text_1" class="intro text-center azera_shop_only_customizer"></h1>';
								}

								if( !empty($azera_shop_header_subtitle) ){
									echo '<h5 id="intro_section_text_2" class="text-center">'.esc_attr($azera_shop_header_subtitle).'</h5>';
								} elseif ( isset( $wp_customize )   ) {
									echo '<h5 id="intro_section_text_2" class="text-center azera_shop_only_customizer"></h5>';
								}
